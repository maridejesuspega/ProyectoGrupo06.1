...
--
-- Host: localhost    Database: practica02
-- ------------------------------------------------------
...
CREATE TABLE `arbol` (
  ...
  `tipo_flor` varchar(100) DEFAULT NULL,
  `dureza_madera` decimal(3,2) DEFAULT NULL,
  `altura_promedio` int DEFAULT NULL,
...
-- Dump completed on 2024-10-26 11:17:52
